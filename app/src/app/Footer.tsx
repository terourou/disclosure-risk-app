...
const Footer = () => {
  ...
  return (
    <footer className="bg-grey-darkest flex flex-wrap items-center justify-between bg-gradient-to-br from-gray-700 to-gray-800 p-4 text-white">
      <div className="flex-no-shrink mr-6 flex flex-col  gap-2 pl-2">
        ...
        <div className="flex items-center gap-2">
          <a href="https://github.com/terourou">
            <svg
              className="h-7 w-7 rounded-full bg-white p-[2px]"
      ...
      <div className="flex-no-shrink flex items-center gap-4">
        <Image src={Rlogo} alt="R Logo" className="w-12" />
